...
#define PROD_CONDITION_CONDITION_A                  0x0027
#define PROD_CONDITION_CONDITION_B                  0x0028
#define PROD_CONDITION_LOGIC                        0x0029
#define PROD_LOGIC_NOT                              0x002A
#define PROD_LOGIC_COMPARISON                       0x002B
#define PROD_COMPARISON_COMPARISON_A                0x002C
#define PROD_COMPARISON_COMPARISON_B                0x002D
#define PROD_COMPARISON_COMPARISON_C                0x002E
#define PROD_COMPARISON_COMPARISON_D                0x002F
#define PROD_COMPARISON_COMPARISON_E                0x0030
#define PROD_COMPARISON_COMPARISON_F                0x0031
#define PROD_COMPARISON_ARITHMETIC                  0x0032
#define PROD_ARITHMETIC_ARITHMETIC_A                0x0033
#define PROD_ARITHMETIC_ARITHMETIC_B                0x0034
#define PROD_ARITHMETIC_TERM                        0x0035
#define PROD_TERM_TERM_A                            0x0036
#define PROD_TERM_TERM_B                            0x0037
#define PROD_TERM_TERM_C                            0x0038
#define PROD_TERM_FACTOR                            0x0039
#define PROD_FACTOR_A                               0x003A
#define PROD_FACTOR_B                               0x003B
#define PROD_FACTOR_FINAL                           0x003C
#define PROD_FINAL                                  0x003D
#define PROD_FINAL_IDENTIFIER_A                     0x003E
#define PROD_FINAL_IDENTIFIER_B                     0x003F
#define PROD_FINAL_IDENTIFIER_C                     0x0040
